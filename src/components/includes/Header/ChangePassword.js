    ...
    onUpdate = async () => {
        if (this.validator.allValid()) {
            if (this.state.newpassword === this.state.confpassword) {
                ...
                let data = { "oldPassword": this.state.password, "password": this.state.newpassword, "confirmPassword": this.state.confpassword, "token": localStorage.getItem('BTDashoardauthToken') }
